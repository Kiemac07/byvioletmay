...
Background/feature imagery is intentionally not clickable; only portfolio work is interactive.

## Booking
The Book Now page is ready for a booking platform to be embedded/connected later.
